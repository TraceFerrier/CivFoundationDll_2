...
void CvGame::InitBuildingMods()
{
	...
	if (handicap == eDeity)
	{
		SetBuildingYieldModifier("BUILDING_GALACTIC_LIBRARY", "YIELD_SCIENCE", 20);
		SetBuildingYieldModifier("BUILDING_SECOND_FOUNDATION_ACADEMY", "YIELD_SCIENCE", 33);
		SetBuildingYieldModifier("BUILDING_FOUNDATION_WORKSHOP", "YIELD_FAITH", 20 );
		SetBuildingYieldModifier("BUILDING_GALACTIC_TEMPLE", "YIELD_PRODUCTION", 20 );
		SetBuildingYieldModifier("BUILDING_FOUNDATION_MARKET", "YIELD_GOLD", 33 );

		SetBuildingYieldChange("BUILDING_GALACTIC_LIBRARY", "YIELD_SCIENCE", 8);
		...
		SetBuildingYieldChange("BUILDING_SECOND_FOUNDATION_ACADEMY", "YIELD_FOOD", 2);
		...
		SetBuildingYieldChange("BUILDING_FOUNDATION_MARKET", "YIELD_GOLD", 6);
	}
	else if (handicap == eImmortal)
	{
		...
		SetBuildingYieldChange("BUILDING_GALACTIC_TEMPLE", "YIELD_FAITH", 6);
